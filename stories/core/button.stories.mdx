...
<Canvas>
  <Story
    ...
    parameters={{
      docs: {
        source: {
          code: `<iu-button text="Secondary" modeType="secondary" (onClick)="click()"></iu-button>`,
        },
      },
    }}
    args={{
...
<Canvas>
  <Story
    ...
    parameters={{
      docs: {
        source: {
          code: `<iu-button text="Tertiary" modeType="tertiary" (onClick)="click()"></iu-button>`,
        },
      },
    }}
    args={{
...
<Canvas>
  <Story
    ...
    parameters={{
      docs: {
        source: {
          code: `<iu-button text="Highlight" modeType="highlight" (onClick)="click()"></iu-button>`,
        },
      },
    }}
    args={{
